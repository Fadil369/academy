#!/usr/bin/env python3
"""
Moodle Course Package Generator for BrainsAIT Academy
Creates a complete Moodle backup file ready for import
"""
...
class MoodleCoursePackager:
    ...
    def create_moodle_package(self):
        """Create a complete Moodle course backup package"""
    ...
    def _create_moodle_backup_xml(self):
        """Create the main moodle_backup.xml file"""
        ...
        for i in range(1, 13):  # 12 activities (3 per module)
        ...
        for i in range(5):  # 0 = general, 1-4 = modules
    ...
    def _create_activities(self):
        ...
        for module_idx, module in enumerate(modules):
            for lesson_idx, lesson in enumerate(module['lessons']):
                ...
                ET.SubElement(page, "intro").text = f"Lesson from {module['title']}"
    ...
    def _copy_resource_files(self):
        """Copy resource files to the package"""
        # Copy the interactive presentation
...
<body>
    ...
    <div class="resource">
        ...
        <ul>
            <li><a href="https://lms.brainsait.com">BrainsAIT LMS</a></li>
            <li><a href="https://github.com/Fadil369/academy">Course Repository</a></li>
            <li><a href="mailto:support@brainsait.com">Technical Support</a></li>
        </ul>
    </div>
</body>
</html>
